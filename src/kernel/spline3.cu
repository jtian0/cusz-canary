    ...
    void* stream)
{
  ...
  constexpr auto BLOCK_3D = dim3(DEFAULT_LINEAR_BLOCK_SIZE, 1, 1);
  ...
  cusz::c_spline3d_infprecis_32x8x8data<T*, E*, float, DEFAULT_LINEAR_BLOCK_SIZE>  //
    ...
    void* stream)
{
  ...
  cusz::x_spline3d_infprecis_32x8x8data<E*, T*, float, DEFAULT_LINEAR_BLOCK_SIZE>  //
      <<<GRID_3D, BLOCK_3D, 0, (GpuStreamT)stream>>>         //
      (ectrl, ec_len3, ec_leap3,                             //
    ...
    void* _outlier, double eb, uint32_t radius, float* time, void* stream)
{
  ...
  cusz::c_spline3d_infprecis_32x8x8data<T*, E*, float, DEFAULT_LINEAR_BLOCK_SIZE>  //
      <<<grid_dim, dim3(DEFAULT_LINEAR_BLOCK_SIZE, 1, 1), 0, (GpuStreamT)stream>>>(

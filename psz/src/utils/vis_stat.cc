...
template void visualize_histogram<uint8_t>(
    const std::string &, uint8_t *, size_t const, size_t const, bool, double,
    double, bool);
template void visualize_histogram<uint16_t>(
    const std::string &, uint16_t *, size_t const, size_t const, bool, double,
    double, bool);
template void visualize_histogram<uint32_t>(
    const std::string &, uint32_t *, size_t const, size_t const, bool, double,
    double, bool);
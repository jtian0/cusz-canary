...
target_link_libraries(spv_cu PRIVATE psztest_utils_cu psz_cu_core)
...
target_link_libraries(decomp_lrz_cu PRIVATE psz_cu_compile_settings psz_cu_test_compile_settings psz_cu_core)
...
target_link_libraries(
  l2_cudaproto PRIVATE psz_cu_compile_settings psz_cu_test_compile_settings psz_cu_mem
  psz_cu_stat)
add_test(test_l2_cudaproto l2_cudaproto)

add_executable(histsp_cu src/test_histsp.cu)
target_link_libraries(histsp_cu PRIVATE psz_cu_compile_settings psz_cu_mem psz_cu_stat
  psz_cu_core psz_seq_core)
...
target_link_libraries(
  l3_cuda_pred PRIVATE psz_cu_core psztest_utils_cu psz_cu_stat psz_cu_mem
  CUDA::cudart)
add_test(test_l3_cuda_pred l3_cuda_pred)

add_executable(lrz_seq src/test_lrz.seq.cc)
target_link_libraries(lrz_seq PRIVATE psz_cu_test_compile_settings)
...
if(PSZ_REACTIVATE_THRUSTGPU)
  ...
  target_link_libraries(statfn PRIVATE psz_cu_test_compile_settings psztest_utils_cu
    psz_cu_stat psz_cu_mem)
else()
  add_executable(statfn src/test_statfn.cc)
  target_link_libraries(statfn PRIVATE psz_cu_test_compile_settings psztest_utils_cu
    psz_cu_stat psz_cu_mem)
